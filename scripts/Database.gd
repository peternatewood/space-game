...
onready var ship_label = get_node("Tabs/Ships/Ship Preview Rows/Ship Preview Label")
onready var weapon_label = get_node("Tabs/Weapons/Weapon Preview Rows/Weapon Preview Label")
onready var weapon_preview = get_node("Tabs/Weapons/Weapon Preview Rows/Weapon Preview")


func _ready():
	var ship_list = get_node("Tabs/Ships/Ship List Scroll Container/Ship List")
	...
	var weapon_list = get_node("Tabs/Weapons/Weapon List Scroll Container/Weapon List")
